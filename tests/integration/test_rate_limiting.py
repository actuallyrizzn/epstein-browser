...
class TestRateLimiting:
    ...
    def test_search_api_rate_limiting(self, client, test_db, test_database, mock_analytics, clean_rate_limiter):
    ...
    def test_image_api_rate_limiting(self, client, test_db, test_database, mock_analytics, clean_rate_limiter):
        ...
        clean_rate_limiter()  # Reset rate limiter
    ...
    def test_stats_api_rate_limiting(self, client, test_db, test_database, mock_analytics, clean_rate_limiter):
    ...
    def test_first_image_api_rate_limiting(self, client, test_db, test_database, mock_analytics, clean_rate_limiter):
    ...
    def test_different_ips_separate_limits(self, client, test_db, test_database, mock_analytics, clean_rate_limiter):
    ...
    def test_different_endpoints_separate_limits(self, client, test_db, test_database, mock_analytics, clean_rate_limiter):
    ...
    def test_rate_limit_headers_accuracy(self, client, test_db, test_database, mock_analytics, clean_rate_limiter):
    ...
    def test_rate_limit_reset_after_window(self, client, test_db, test_database, mock_analytics, clean_rate_limiter):
    ...
    def test_rate_limit_error_response_structure(self, client, test_db, test_database, mock_analytics, clean_rate_limiter):
    ...
    def test_rate_limit_headers_on_success(self, client, test_db, test_database, mock_analytics, clean_rate_limiter):
    ...
    def test_rate_limit_headers_on_error(self, client, test_db, test_database, mock_analytics, clean_rate_limiter):
